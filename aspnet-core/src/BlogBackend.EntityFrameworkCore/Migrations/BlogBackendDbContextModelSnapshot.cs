...
{
    [DbContext(typeof(BlogBackendDbContext))]
    partial class BlogBackendDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogBackend.Entities.BlogCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlogBackend.Entities.BlogComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("IsFromRegisteredUser")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AppBlogComments", (string)null);
                });

            modelBuilder.Entity("BlogBackend.Entities.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlogBackend.Entities.BlogPostTag", b =>
                {
                    b.Property<Guid>("BlogPostId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlogBackend.Entities.BlogTag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlogBackend.Entities.BlogCategory", b =>
                {
                    b.HasOne("BlogBackend.Entities.BlogCategory", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("BlogBackend.Entities.BlogComment", b =>
                {
                    b.HasOne("BlogBackend.Entities.BlogPost", "BlogPost")
                        .WithMany("Comments")
                        .HasForeignKey("BlogPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlogBackend.Entities.BlogComment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("BlogBackend.Entities.BlogPost", b =>
                {
                    b.HasOne("BlogBackend.Entities.BlogCategory", "Category")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("BlogBackend.Entities.BlogPostTag", b =>
                {
                    ...
                    b.HasOne("BlogBackend.Entities.BlogTag", "BlogTag")
                        .WithMany("Posts")
